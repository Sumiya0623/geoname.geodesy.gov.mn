    ...
    class FunctionPermission(BasePermission):
        ...
        def has_permission(self, request, view):
            ...
            if action_name in ['sync','partial_update','add_action','remove_action','menus']:
                action_name='update'
            if action_name in ['menus','related','system_registered','network_registered','submenu_actions','nameclass','types','locate','dropdown','unit_tree','type_summary','find_person']:
                action_name='list'
