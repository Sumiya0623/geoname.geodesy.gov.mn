    ...
    >
      ...
      {onAddName && (
        <Tooltip title="Шинэ нэр нэмэх — зурсан геометрийн дагуу (төрөл нь энэ давхаргаар сет хийгдсэн)">
          <IconButton color="primary" onClick={onAddName}>
      ...
      {onLinkName && (
        <Tooltip title="Батлагдсан нэрийн байр зүйн холболт">
          <IconButton color="primary" onClick={onLinkName}>
      ...
      {onFieldCalc && (
        <Tooltip title="Талбар тооцоолуур — баганын утгыг бөөнөөр шинэчлэх">
          <IconButton onClick={onFieldCalc}>
      ...
      <Tooltip title="Багана харуулах/нуух">
        <IconButton onClick={(e) => setColMenu(e.currentTarget)}>
