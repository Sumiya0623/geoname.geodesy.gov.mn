...
import GeoserverDialog from "src/sections/map/geoserverDialog";
import FeatureTabPanel from "src/sections/map/FeatureTabPanel";
import RecountEditDialog from "src/sections/map/RecountEditDialog";
import FieldCalcDialog from "src/sections/map/FieldCalcDialog";
...
// status_id → өнгө (map нь RECOUNT_STATUS татаж дүүргэнэ)
  ...
  const renderSearchTab = (
    ...
    >
      ...
      <TableContainer sx={{ flex: 1, position: "relative", overflow: "auto" }}>
        <Scrollbar>
          <Table sx={{ minWidth: 640 }} stickyHeader>
            <TableHeadCustom
      ...
      >
        ...
        {mapNotice && (
          ...
          >
            ...
            <Box sx={{ flex: 1 }} />
            <IconButton onClick={() => setMapNotice(null)}>
