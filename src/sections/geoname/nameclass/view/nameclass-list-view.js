...
export default function NameClassListView({ embedded = false }) {
  ...
  // «Төрөл нэмэх» товч — ЗӨВХӨН бие даасан хуудсанд. Таб дотор (embedded)
  // төрөл нэмэх/засах ойлголт байхгүй тул харуулахгүй.
  const addAction = !embedded && menuPermissions?.create ? (
    <Button
      color="primary"
      variant="contained"
  ...
  return (
    <Container maxWidth={embedded ? false : "xxl"} disableGutters={embedded}>
      {embedded ? null : (
        <CustomBreadcrumbs
          heading="Дэвсгэр нэр"
          links={[
