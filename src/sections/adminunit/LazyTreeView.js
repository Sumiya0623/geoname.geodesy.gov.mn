...
function LevelRow({
  ...
  const {
    units: childUnits = [],
    unitsLoading: childLoading = false,
    unitsCount: childCount = 0,
    unitsMutation: childMutation,
  } = useGetUnits(
    ...
    <>
      ...
      >
        <IconButton
          ...
          id={`unit-exp-${effectivePath.join("-")}`}
        >
          <Icon
            icon={
        ...
        <Stack direction="row" alignItems="center" spacing={2} flexGrow={1}>
          ...
          {/* <Typography variant="subtitle2">{item?.centerName}</Typography> */}
        </Stack>
        ...
        <Typography
          variant="subtitle2"
          id={`unit-count-${effectivePath.join("-")}`}
        >
          {item?.subcount != 0 && item?.subcount}
        </Typography>

        {menuPermissions?.create && canHaveChildren && (
          <IconButton
            size="small"
            ...
            id={`unit-add-${effectivePath.join("-")}`}
          >
            <Icon
              icon={
                childFormOpen
        ...
        {menuPermissions?.copy && (
          <IconButton
            ...
            id={`unit-dup-${effectivePath.join("-")}`}
          >
            <Icon
              icon={
        ...
        {(menuPermissions?.update || menuPermissions?.delete) &&
          <IconButton
            ...
            id={`unit-edit-${effectivePath.join("-")}`}
          >
