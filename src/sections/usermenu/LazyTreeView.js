...
function LevelRow({
  ...
  const {
    menus: childs = [],
    menusLoading: childLoading = false,
    menusCount: childCount = 0,
    menusMutation: childMutation,
  } = useGetMenus(
    ...
    <>
      ...
      >
        <IconButton
          ...
          id={`menu-exp-${effectivePath.join("-")}`}
        >
          <Icon
            icon={
        ...
        <Typography
          ...
          id={`menu-order-${effectivePath.join("-")}`}
        >
          {item.code}
        </Typography>
        ...
        {(menuPermissions?.update || menuPermissions?.delete) && (
          <IconButton
            ...
            id={`menu-edit-${effectivePath.join("-")}`}
          >
