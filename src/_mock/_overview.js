...
export const _appInvoices = [...Array(5)].map((_, index) => {
  const category = [
    'Геодезийн байнгын цэг тэмдэгтийн судалгаа, барьж байгуулах',
    'Геодезийн байрлал, өндөр, гравиметрийн сүлжээ байгуулах',
    'Агаарын зураглапын төлөвлөгөө боловсруулах',
    'Геодезийн хэмжих хэрэгслийн хэмжил зүйн тохируулга, баталгаажуулалт',
    'Инженер геодезийн ажил'][index];

  const status = ['70-90%', '0-30%', '30-70%', '70-90%', '70-90%'][index];
